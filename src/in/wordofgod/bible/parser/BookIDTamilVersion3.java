 ...
 */
public enum BookIDTamilVersion3 {
	...
	BOOK_1Sam("1Sam", false, 9, "1 சாமு","1 சாமு",90),
	BOOK_2Sam("2Sam", false, 10, "2 சாமு","2 சாமு",100),
	BOOK_1Kgs("1Kgs", false, 11, "1 இராஜா","1 இராஜா",110),
	BOOK_2Kgs("2Kgs", false, 12, "2 இராஜா","2 இராஜா",120),
	BOOK_1Chr("1Chr", false, 13, "1 நாளா","1 நாளா",130),
	BOOK_2Chr("2Chr", false, 14, "2 நாளா","2 நாளா",140),
	...
	BOOK_Joel("Joel", false, 29, "யோவே","யோவே",360),
	...
	BOOK_Acts("Acts", true, 44, "அப்","அப்",510),
	BOOK_Rom("Rom", true, 45, "ரோமர்","ரோமர்",520),
	BOOK_1Cor("1Cor", true, 46, "1 கொரி","1 கொரி",530),
	BOOK_2Cor("2Cor", true, 47, "2 கொரி","2 கொரி",540),
	...
	BOOK_1Thess("1Thess", true, 52, "1 தெச","1 தெச",590),
	BOOK_2Thess("2Thess", true, 53, "2 தெச","2 தெச",600),
	BOOK_1Tim("1Tim", true, 54, "1 தீமோ","1 தீமோ",610),
	BOOK_2Tim("2Tim", true, 55, "2 தீமோ","2 தீமோ",620),
	...
	BOOK_1Pet("1Pet", true, 60, "1 பேது","1 பேது",670),
	BOOK_2Pet("2Pet", true, 61, "2 பேது","2 பேது",680),
	BOOK_1John("1John", true, 62, "1 யோவா","1 யோவா",690),
	BOOK_2John("2John", true, 63, "2 யோவா","2 யோவா",700),
	BOOK_3John("3John", true, 64, "3 யோவா","3 யோவா",710),
	BOOK_Jude("Jude", true, 65, "யூதா","யூதா",720),
	BOOK_Rev("Rev", true, 66, "வெளி","வெளி",730),
	...
	private BookIDTamilVersion3(String osisID, boolean nt, int zefID, String englishName, String threeLetterCode, int myBibleZoneId) {
		this.osisID = osisID;
		this.nt = nt;
		this.zefID = zefID;
	...
	public static BookIDTamilVersion3 fromZefId(int zefId) {
		for (BookIDTamilVersion3 id : values()) {
			if (id.zefID == zefId)
				return id;
		}
	...
	public static BookIDTamilVersion3 fromOsisId(String osisId) {
		for (BookIDTamilVersion3 id : values()) {
