 ...
 */
public enum BookIDTamilVersion5 {
	...
	BOOK_Josh("Josh", false, 6, "யோசு","யோசு",60),
	BOOK_Judg("Judg", false, 7, "நியா","நியா",70),
	BOOK_Ruth("Ruth", false, 8, "ரூ","ரூத்",80),
	BOOK_1Sam("1Sam", false, 9, "1 சா","1 சாமு",90),
	BOOK_2Sam("2Sam", false, 10, "2 சா","2 சாமு",100),
	BOOK_1Kgs("1Kgs", false, 11, "1 இரா","1 இராஜா",110),
	BOOK_2Kgs("2Kgs", false, 12, "2 இரா","2 இராஜா",120),
	BOOK_1Chr("1Chr", false, 13, "1 நா","1 நாளா",130),
	BOOK_2Chr("2Chr", false, 14, "2 நா","2 நாளா",140),
	BOOK_Ezra("Ezra", false, 15, "எஸ்றா","எஸ்றா",150),
	BOOK_Neh("Neh", false, 16, "நெ","நெகே",160),
	BOOK_Esth("Esth", false, 17, "எஸ்","எஸ்",190),
	BOOK_Job("Job", false, 18, "யோபு","யோபு",220),
	...
	BOOK_Joel("Joel", false, 29, "யோவேல்","யோவே",360),
	BOOK_Amos("Amos", false, 30, "ஆமோ","ஆயோ",370),
	BOOK_Obad("Obad", false, 31, "ஒப","ஒப",380),
	BOOK_Jonah("Jonah", false, 32, "யோனா","யோனா",390),
	...
	BOOK_John("John", true, 43, "யோவா","யோவா",500),
	BOOK_Acts("Acts", true, 44, "அ","அப்",510),
	BOOK_Rom("Rom", true, 45, "ரோ","ரோமர்",520),
	BOOK_1Cor("1Cor", true, 46, "1 கொரிந்","1 கொரி",530),
	BOOK_2Cor("2Cor", true, 47, "2 கொரிந்","2 கொரி",540),
	...
	BOOK_1Thess("1Thess", true, 52, "1 தெசலோ","1 தெச",590),
	BOOK_2Thess("2Thess", true, 53, "2 தெசலோ","2 தெச",600),
	BOOK_1Tim("1Tim", true, 54, "1 தீமோத்","1 தீமோ",610),
	BOOK_2Tim("2Tim", true, 55, "2 தீமோத்","2 தீமோ",620),
	...
	BOOK_1John("1John", true, 62, "1யோவான்","1 யோவா",690),
	BOOK_2John("2John", true, 63, "2யோவான்","2 யோவா",700),
	BOOK_3John("3John", true, 64, "3யோவான்","3 யோவா",710),
	...
	private BookIDTamilVersion5(String osisID, boolean nt, int zefID, String englishName, String threeLetterCode, int myBibleZoneId) {
		this.osisID = osisID;
		this.nt = nt;
		this.zefID = zefID;
	...
	public static BookIDTamilVersion5 fromZefId(int zefId) {
		for (BookIDTamilVersion5 id : values()) {
			if (id.zefID == zefId)
				return id;
		}
	...
	public static BookIDTamilVersion5 fromOsisId(String osisId) {
		for (BookIDTamilVersion5 id : values()) {
