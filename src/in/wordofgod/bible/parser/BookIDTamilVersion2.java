 ...
 */
public enum BookIDTamilVersion2 {
	...
	BOOK_Josh("Josh", false, 6, "யோசுவா","யோசு",60),
	BOOK_Judg("Judg", false, 7, "நியாயாதிபதிகள்","நியா",70),
	BOOK_Ruth("Ruth", false, 8, "ரூத்","ரூத்",80),
	BOOK_1Sam("1Sam", false, 9, "1சாமுவேல்","1 சாமு",90),
	BOOK_2Sam("2Sam", false, 10, "2சாமுவேல்","2 சாமு",100),
	BOOK_1Kgs("1Kgs", false, 11, "1இராஜாக்கள்","1 இராஜா",110),
	BOOK_2Kgs("2Kgs", false, 12, "2இராஜாக்கள்","2 இராஜா",120),
	BOOK_1Chr("1Chr", false, 13, "1நாளாகமம்","1 நாளா",130),
	BOOK_2Chr("2Chr", false, 14, "2நாளாகமம்","2 நாளா",140),
	...
	BOOK_Prov("Prov", false, 20, "நீதிமொழிகள்","நீதி",240),
	...
	BOOK_Amos("Amos", false, 30, "ஆமோஸ்","ஆமோ",370),
	...
	BOOK_John("John", true, 43, "யோவான்","யோவா",500),
	BOOK_Acts("Acts", true, 44, "அப்போஸ்தலர்","அப்",510),
	BOOK_Rom("Rom", true, 45, "ரோமர்","ரோமர்",520),
	BOOK_1Cor("1Cor", true, 46, "1கொரிந்தியர்","1 கொரி",530),
	BOOK_2Cor("2Cor", true, 47, "2கொரிந்தியர்","2 கொரி",540),
	BOOK_Gal("Gal", true, 48, "கலாத்தியர்","கலா",550),
	BOOK_Eph("Eph", true, 49, "எபேசியர்","எபே",560),
	BOOK_Phil("Phil", true, 50, "பிலிப்பியர்","பிலி",570),
	BOOK_Col("Col", true, 51, "கொலோசெயர்","கொலோ",580),
	BOOK_1Thess("1Thess", true, 52, "1தெசலோனிக்கேயர்","1 தெச",590),
	BOOK_2Thess("2Thess", true, 53, "2தெசலோனிக்கேயர்","2 தெச",600),
	BOOK_1Tim("1Tim", true, 54, "1தீமோத்தேயு","1 தீமோ",610),
	BOOK_2Tim("2Tim", true, 55, "2தீமோத்தேயு","2 தீமோ",620),
	BOOK_Titus("Titus", true, 56, "தீத்து","தீத்து",630),
	BOOK_Phlm("Phlm", true, 57, "பிலேமோன்","பிலே",640),
	BOOK_Heb("Heb", true, 58, "எபிரெயர்","எபி",650),
	BOOK_Jas("Jas", true, 59, "யாக்கோபு","யாக்",660),
	BOOK_1Pet("1Pet", true, 60, "1பேதுரு","1 பேது",670),
	BOOK_2Pet("2Pet", true, 61, "2பேதுரு","2 பேது",680),
	BOOK_1John("1John", true, 62, "1யோவான்","1 யோவா",690),
	BOOK_2John("2John", true, 63, "2யோவான்","2 யோவா",700),
	BOOK_3John("3John", true, 64, "3யோவான்","3 யோவா",710),
	BOOK_Jude("Jude", true, 65, "யூதா","யூதா",720),
	BOOK_Rev("Rev", true, 66, "வெளிப்படுத்தினவிசேஷம்","வெளி",730),
	...
	private BookIDTamilVersion2(String osisID, boolean nt, int zefID, String englishName, String threeLetterCode, int myBibleZoneId) {
		this.osisID = osisID;
		this.nt = nt;
		this.zefID = zefID;
	...
	public static BookIDTamilVersion2 fromZefId(int zefId) {
		for (BookIDTamilVersion2 id : values()) {
			if (id.zefID == zefId)
				return id;
		}
	...
	public static BookIDTamilVersion2 fromOsisId(String osisId) {
		for (BookIDTamilVersion2 id : values()) {
