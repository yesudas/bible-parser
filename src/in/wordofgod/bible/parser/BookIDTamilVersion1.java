 ...
 */
public enum BookIDTamilVersion1 {
	...
	BOOK_Gen("Gen", false, 1, "ஆதியாகமம்","ஆதி",10),
	BOOK_Exod("Exod", false, 2, "யாத்திராகமம்","யாத்",20),
	BOOK_Lev("Lev", false, 3, "லேவியராகமம்","லேவி",30),
	BOOK_Num("Num", false, 4, "எண்ணாகமம்","எண்",40),
	BOOK_Deut("Deut", false, 5, "உபாகமம்","உபா",50),
	BOOK_Josh("Josh", false, 6, "யோசுவா","யோசு",60),
	BOOK_Judg("Judg", false, 7, "நியாயாதிபதிகள்","நியா",70),
	BOOK_Ruth("Ruth", false, 8, "ரூத்","ரூத்",80),
	BOOK_1Sam("1Sam", false, 9, "1 சாமுவேல்","1 சாமு",90),
	BOOK_2Sam("2Sam", false, 10, "2 சாமுவேல்","2 சாமு",100),
	BOOK_1Kgs("1Kgs", false, 11, "1 இராஜாக்கள்","1 இராஜா",110),
	BOOK_2Kgs("2Kgs", false, 12, "2 இராஜாக்கள்","2 இராஜா",120),
	BOOK_1Chr("1Chr", false, 13, "1 நாளாகமம்","1 நாளா",130),
	BOOK_2Chr("2Chr", false, 14, "2 நாளாகமம்","2 நாளா",140),
	BOOK_Ezra("Ezra", false, 15, "எஸ்றா","எஸ்றா",150),
	BOOK_Neh("Neh", false, 16, "நெகேமியா","நெகே",160),
	BOOK_Esth("Esth", false, 17, "எஸ்தர்","எஸ்",190),
	BOOK_Job("Job", false, 18, "யோபு","யோபு",220),
	BOOK_Ps("Ps", false, 19, "சங்கீதம்","சங்",230),
	BOOK_Prov("Prov", false, 20, "நீதிமொழிகள்","நீதி",240),
	BOOK_Eccl("Eccl", false, 21, "பிரசங்கி","பிர",250),
	BOOK_Song("Song", false, 22, "உன்னதப்பாட்டு","உன்",260),
	BOOK_Isa("Isa", false, 23, "ஏசாயா","ஏசா",290),
	BOOK_Jer("Jer", false, 24, "எரேமியா","எரே",300),
	BOOK_Lam("Lam", false, 25, "புலம்பல்","புல",310),
	BOOK_Ezek("Ezek", false, 26, "எசேக்கியேல்","எசே",330),
	BOOK_Dan("Dan", false, 27, "தானியேல்","தானி",340),
	BOOK_Hos("Hos", false, 28, "ஓசியா","ஓசி",350),
	BOOK_Joel("Joel", false, 29, "யோவேல்","யோவே",360),
	BOOK_Amos("Amos", false, 30, "ஆமோஸ்","ஆயோ",370),
	BOOK_Obad("Obad", false, 31, "ஒபதியா","ஒப",380),
	BOOK_Jonah("Jonah", false, 32, "யோனா","யோனா",390),
	BOOK_Mic("Mic", false, 33, "மீகா","மீகா",400),
	BOOK_Nah("Nah", false, 34, "நாகூம்","நாகூம்",410),
	BOOK_Hab("Hab", false, 35, "ஆபகூக்","ஆப",420),
	BOOK_Zeph("Zeph", false, 36, "செப்பனியா","செப்",430),
	BOOK_Hag("Hag", false, 37, "ஆகாய்","ஆகாய்",440),
	BOOK_Zech("Zech", false, 38, "சகரியா","சக",450),
	BOOK_Mal("Mal", false, 39, "மல்கியா","மல்",460),

	INTRODUCTION_NT("x-IntrNT", true, -3, "Introduction NT", "INT", 0),

	BOOK_Matt("Matt", true, 40, "மத்தேயு","மத்",470),
	BOOK_Mark("Mark", true, 41, "மாற்கு","மாற்",480),
	BOOK_Luke("Luke", true, 42, "லூக்கா","லூக்",490),
	BOOK_John("John", true, 43, "யோவான்","யோவா",500),
	BOOK_Acts("Acts", true, 44, "அப்போஸ்தலர்","அப்",510),
	BOOK_Rom("Rom", true, 45, "ரோமர்","ரோமர்",520),
	BOOK_1Cor("1Cor", true, 46, "1 கொரிந்தியர்","1 கொரி",530),
	BOOK_2Cor("2Cor", true, 47, "2 கொரிந்தியர்","2 கொரி",540),
	BOOK_Gal("Gal", true, 48, "கலாத்தியர்","கலா",550),
	BOOK_Eph("Eph", true, 49, "எபேசியர்","எபே",560),
	BOOK_Phil("Phil", true, 50, "பிலிப்பியர்","பிலி",570),
	BOOK_Col("Col", true, 51, "கொலோசெயர்","கொலோ",580),
	BOOK_1Thess("1Thess", true, 52, "1 தெசலோனிக்கேயர்","1 தெச",590),
	BOOK_2Thess("2Thess", true, 53, "2 தெசலோனிக்கேயர்","2 தெச",600),
	BOOK_1Tim("1Tim", true, 54, "1 தீமோத்தேயு","1 தீமோ",610),
	BOOK_2Tim("2Tim", true, 55, "2 தீமோத்தேயு","2 தீமோ",620),
	BOOK_Titus("Titus", true, 56, "தீத்து","தீத்து",630),
	BOOK_Phlm("Phlm", true, 57, "பிலேமோன்","பிலே",640),
	BOOK_Heb("Heb", true, 58, "எபிரெயர்","எபி",650),
	BOOK_Jas("Jas", true, 59, "யாக்கோபு","யாக்",660),
	BOOK_1Pet("1Pet", true, 60, "1 பேதுரு","1 பேது",670),
	BOOK_2Pet("2Pet", true, 61, "2 பேதுரு","2 பேது",680),
	BOOK_1John("1John", true, 62, "1 யோவான்","1 யோவா",690),
	BOOK_2John("2John", true, 63, "2 யோவான்","2 யோவா",700),
	BOOK_3John("3John", true, 64, "3 யோவான்","3 யோவா",710),
	BOOK_Jude("Jude", true, 65, "யூதா","யூதா",720),
	BOOK_Rev("Rev", true, 66, "வெளிப்படுத்தின விசேஷம்","வெளி",730),
	...
	private BookIDTamilVersion1(String osisID, boolean nt, int zefID, String englishName, String threeLetterCode, int myBibleZoneId) {
		this.osisID = osisID;
		this.nt = nt;
		this.zefID = zefID;
	...
	public static BookIDTamilVersion1 fromZefId(int zefId) {
		for (BookIDTamilVersion1 id : values()) {
			if (id.zefID == zefId)
				return id;
		}
	...
	public static BookIDTamilVersion1 fromOsisId(String osisId) {
		for (BookIDTamilVersion1 id : values()) {
